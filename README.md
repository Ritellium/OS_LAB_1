# OS_Lab_1, Актуально для: *Коммит [2]
// ----- Задача: -----
...
получает через командную строку. Записи файла вводятся с консоли.
...
*Коммит [2] написан на 98-ом стандарте С++ (Ну почти)

Creator -- полностью работоспособен
Reporter -- Неправильно записывает данные в файл, но правильно сортирует...
Main -- Неправильно выводит данные Reporter'a на консоль. Остальное в норме

Код ~ужасный, тестов нет, обработка исключений зачаточная
